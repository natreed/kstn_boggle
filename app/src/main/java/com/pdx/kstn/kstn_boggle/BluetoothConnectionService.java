...
public class BluetoothConnectionService {
    ...
    private static final String NAME = "Boggle";

    // Unique UUID for this application
    private static final UUID MY_UUID = UUID.fromString("af87c0d0-afac-11de-8a39-0800200c9a66");
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(MultiPlayerActivity.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(MultiPlayerActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MultiPlayerActivity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(MultiPlayerActivity.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
                    connectionLost();
                    break;
