...
public class ChooseModeMainActivity extends Activity{
    ...
    private void addListenerOnButtons() {
        ...
        btt_startgame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (str_mode.equals("singleplayer"))
                    intend = new Intent(getApplicationContext(), PlayerActivity.class);
                else
                    intend = new Intent(getApplicationContext(), MultiPlayerActivity.class);
